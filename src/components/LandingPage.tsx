...
export function LandingPage() {
  ...
  // Giriş yapılmışsa direkt uygulamaya al
  useEffect(() => {
    ...
    <div className="relative min-h-screen bg-[#0a062b] text-[#f4f2e2] font-sans overflow-x-hidden">
      ...
      <section className="relative z-10 px-6 py-32 max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <FeatureCard
            ...
            desc="Bilim destekli nefes teknikeleri sesli rehberlik ile. Kaygıyı saatlerce değil, dakikalar içinde dağıt."
            delay={0.1}
          />
          <FeatureCard
            icon="◐"
      ...
      <section id="how" className="relative z-10 px-6 py-32 max-w-2xl mx-auto">
        ...
        <div className="space-y-10">
          <Step n="01" text="Ne hissettiğini söyle — kelimeler yeterliyse, bir kelime bile yeterli." delay={0} />
      ...
      {/* ── FOOTER ── */}
      <footer className="relative z-10 px-8 py-12 flex flex-col sm:flex-row items-center justify-between gap-4 border-t border-[#f4f2e2]/5">
        <span className="text-xs tracking-[0.4em] uppercase text-[#f4f2e2]/20 font-light">Viwra</span>
        <p className="text-[10px] text-[#f4f2e2]/15 font-light tracking-wide text-center">
